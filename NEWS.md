...
https://github.com/swihart/growth to see the changes required 
to pass CRAN checks.
I'll try to document the changes henceforth here and at 
https://github.com/swihart/growth/issues.

  *  `plot_cum()` replaces `plot.cum()`

**Above this line will be News/Changes for `growth` only**
